...
train_step = tf.train.AdamOptimizer(learning_rate=.0005, beta1=.9, beta2=.999).minimize(cross_entropy)
...
kf_iterator = model_selection.StratifiedKFold(n_splits=42, shuffle=True)  # Stratified
count = 0
